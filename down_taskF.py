...
def main():
    ...
    model_path = "TaskF_20251109_184456.pth"
    ...
    for condition in conditions:
        ...
        results = test_mtl_ssl(
            ...
            learning_rate=1e-3,
            batch_size=16,
            results_save_path=f"TaskF_epoch1000_down1000__Total{condition.lower()}_results_{unique_id}.json",
            device=device
        )
