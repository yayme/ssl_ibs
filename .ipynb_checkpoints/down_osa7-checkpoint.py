...
def main():
    ...
    ahi_df['OSA'] = ((ahi_df['AHI'] >= 15) & (ahi_df['ISI']<15)).astype(int)
    ahi_df['Insomnia'] = ((ahi_df['ISI'] >= 15) & (ahi_df['AHI']<15)).astype(int)
    ...
    for condition in conditions:
        ...
        results = test_ssl(
            ...
            learning_rate=1e-3,
            batch_size=16,
            results_save_path=f"2000epochdownstream_ TaskN1__{condition.lower()}_results_{unique_id}.json",
            device=device
        )
