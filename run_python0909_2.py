...
print("\n🚀 Training and Testing Downstream Classifier from Scratch (No SSL)")
print("="*80)
import sys
sys.path.append('.')
from ssl_utils import test_scratch_classifier

results = test_scratch_classifier(
    ...
    learning_rate=1e-3,
    batch_size=16,
    results_save_path="scratch_ahi_classification_results.json"
)

print("\n✅ Scratch classifier training and evaluation completed!")
