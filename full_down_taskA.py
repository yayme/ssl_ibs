...
import numpy as np
import torch
from ssl_utils import full_test_mtl,set_random_seed
...
def main():
    ...
    processed_data = processor.preprocess_data(watch_labeled, config['features'], segment_length=20000)
    ...
    for condition in conditions:
        ...
        results = full_test_mtl(
            ...
            learning_rate=1e-3,
            batch_size=16,
            results_save_path=f"full_TaskA_epoch1000_down20__Total{condition.lower()}_results_{unique_id}.json",
            device=device,
